        ...
        <div className="mt-8 bg-gray-100 py-12">
            <section data-aos="fade-up">
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl text-[#21314f] uppercase font-bold">Reviews</h2>
                    <div className='flex justify-center'>
                        <div className='w-24 border-b-4 border-blue-900'></div>
                    </div>
                    <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-[#21314f]">
                        Some of our clients have something to say
                    </h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-8 lg:px-16" data-aos="fade-in" data-aos-delay="600">
                    {/* Card 1 */}
                    <div className="bg-white shadow-lg p-6 flex flex-col justify-between rounded-r-xl">
                        ...
                        <p className="mt-4 text-right text-gray-500 font-semibold">- Nicolas Weidman, Switzerland</p>
                    </div>
                    ...
                    <div className="bg-white shadow-lg rounded-xl p-6 flex flex-col justify-between">
                        ...
                        <p className="mt-4 text-right text-gray-500 font-semibold">- an NLP Project, Pakistani Client</p>
                    </div>

                    {/* Card 3 */}
                    <div className="bg-white shadow-lg rounded-l-xl p-6 flex flex-col justify-between">
                        <p className="text-lg italic text-gray-700">
                        ...
                        <p className="mt-4 text-right text-gray-500 font-semibold">- A consultancy project</p>
                    </div>
                </div>
            </section>
        </div>
